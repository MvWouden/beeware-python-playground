...
class BeeWarePlayground(toga.App):
    ...
    def startup(self: "BeeWarePlayground") -> None:
    ...
    def say_hello(self: "BeeWarePlayground", widget: toga.Button) -> None:
        """Say hello to user.

        Parameters
        ----------
        widget : toga.Button
            The widget calling this method.
        """
        print(f"Hello, {self.name_input.value}")


def main() -> BeeWarePlayground:
    """Run the BeeWare Playground.
